            ...
            <div className="bg-slate-gray rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
              <div className="md:flex">
                <div className="md:flex-shrink-0">
                  <Image src="/project-placeholder.jpg" alt="Shellharbour Dive Tour Website" width={500} height={350} className="h-full w-full object-cover md:w-64" />
                </div>
                <div className="p-8">
                  <div className="uppercase tracking-wide text-sm text-navy-green font-semibold">Web Design & Development</div>
                  <a href="/dive-tour" className="block mt-1 text-lg leading-tight font-medium text-white hover:underline">Shellharbour Dive Tour Business Website</a>
                  <p className="mt-2 text-light-slate">A comprehensive, multi-page website designed to showcase a local dive tour business. Featuring an interactive booking calendar, dive site map, photo gallery, and more. This project demonstrates a full-stack approach to building a modern, user-friendly web application.</p>
                  <a href="/dive-tour" className="mt-4 inline-block bg-navy-green text-midnight-blue px-6 py-2 rounded-full font-bold hover:bg-white transition-colors">View Project &rarr;</a>
                </div>
              </div>
            </div>
          </div>
